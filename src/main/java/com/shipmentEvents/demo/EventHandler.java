...
public class EventHandler implements RequestHandler<ScheduledEvent, String> {
   ...
   * <p>
   * The events are stored in following format: - Each status update is a file, where the name of
   ...
   * package.
   * <p>
   * A Sample files looks as below: FILE-NAME-> '8787323232232332--55322798-dd29-4a04-97f4-93e18feed554'
   * >status:IN TRANSIT >timestamp: 1573410202 >Other fields like...tracking history and address
   */
  public String handleRequest(ScheduledEvent scheduledEvent, Context context) {
    ...
    try {
      ...
      logger.log(String
          .format("Failed to process shipment Updates in %s due to %s", scheduledEvent.getAccount(),
              ex.getMessage()));
